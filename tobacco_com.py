...
def train_test_plot(method_name = "_"):
    ...
    plt.tight_layout()
    plt.savefig(f"output_lr_{learning_rate}_batchsize_{batchsize}_{method_name}_document_dataset_accuracy_curve_IEEE.png", dpi=300)  # Save the figure with high resolution
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(f"output_lr_{learning_rate}_batchsize_{batchsize}_{method_name}_dataset_loss_curve_IEEE.png", dpi=300)
    plt.show()
